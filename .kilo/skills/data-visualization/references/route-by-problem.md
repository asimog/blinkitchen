...
- Route mobile-first responsive concerns, paired large-screen/mobile concept sets, touch/pinch/keyboard behavior, spotty connections, and device capability audits through `foundations/mobile-first-responsive-visualization.md` before treating them as CSS-only cleanup.
...
- Route fictional, invented, illustrative, or synthetic editorial stories through `foundations/fictional-data-story-simulation.md` before art direction or implementation.
- Route embedded visualizations inside reports, stories, parallax, editorials, visual articles, and decks through `foundations/embedded-visualization-self-use.md`: inventory the layers, assign specialist owners, write mini-briefs, and use authorized delegation or local fresh specialist passes for substantial layers.
...
- `foundations/mobile-first-responsive-visualization.md`
